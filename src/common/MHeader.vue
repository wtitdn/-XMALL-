...
.w-box {
  ...
  h1 {
    ...
    align-items: center;
    > a {
      background: url(../../public/static/images/global-logo-red@2x.png) no-repeat 50%;
  ...
  .user {
    ...
    > a {
      ...
      &:before {
        ...
        top: 0;
        @include wh(20px);
        background: url(../../public/static/images/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png) -155px
          0;
  ...
  .shop {
    ...
    > a {
      ...
      &:before {
        ...
        @include wh(30px, 100%);
        content: " ";
        background: url(../../public/static/images/account-icon@2x.32d87deb02b3d1c3cc5bcff0c26314ac.png)
          0 -22px;
        background-size: 240px 107px;
...
.cart-con:before {
  ...
  width: 76px;
  height: 62px;
  background: url("../../public/static/images/cart-empty-new.png") no-repeat;
  background-size: cover;
}
</style>